...
namespace FunFox.PortalSystem.Infrastructure.Migrations
{
    public partial class FunFoxMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxClassSize = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FunFoxClasses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAsOf = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlantMaterials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlantMaterials_AllPlants_PlantId",
                        column: x => x.PlantId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlantMaterials_PlantId",
                table: "PlantMaterials",
                column: "PlantId");
        }
